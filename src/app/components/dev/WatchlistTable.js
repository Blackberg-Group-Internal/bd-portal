        ...
        <div className="row border-bottom position-relative overflow-scroll">
          <div className="col-12 px-0 py-0 table-header">
            <div className="d-flex align-items-start py-0">
              ...
              <div className="col-1 pointer p-3 bg-light">Lead{' '}</div>
              <div className="col-1 pointer p-3 bg-light">Support{' '}</div>
              <div className="col-1 pointer p-3 bg-light">Reviewer{' '}</div>
              <div className="col-2 pointer p-3 bg-light" onClick={() => sortBy('priority')}>
                Priority{' '}
              ...
              <div className="col-2 pointer p-3 bg-light" onClick={() => sortBy('stage')}>
                Stage{' '}
              ...
              <div className="col-2 pointer p-3 bg-light" onClick={() => sortBy('status')}>
                Status{' '}
          ...
          {currentItems.map((item, index) => (
            <div className="col-12 px-0 list-row pointer py-0" key={item.id || index}   onClick={() => handleViewOpportunity(item)}>
              <div className="d-flex align-items-center px-0 py-0 h-100">
                ...
                <div className="col-1 small  py-2 d-flex border h-100 px-3 d-flex align-items-center justify-content-center">{renderInitials(item.lead)}</div>
                <div className="col-1 small  py-2 d-flex border h-100 px-3 d-flex align-items-center justify-content-center">{renderInitials(item.support)}</div>
                <div className="col-1 small  py-2 d-flex border h-100 px-3 d-flex align-items-center justify-content-center">{renderInitials(item.reviewer)}</div>
                <div className="col-2 small  py-2 px-3 h-100 border d-flex align-items-center">{formatText(item.priority)}</div>
                ...
                <div className="col-2 small text-truncate py-2  border h-100 px-3 d-flex align-items-center">{formatText(item.stage)}</div>
                <div className="col-2 small text-truncate py-2 border h-100 px-3 d-flex align-items-center">{formatText(item.status)}</div>
