...
export async function POST(req) {
  try {
    ...
    // It should be one single JSON Object. RETURN ONLY JSON. NO TEXT BEFORE OR AFTER.
    ...
    const agentPrompt = `
      ...
      NAICS: Extract relevant NAICS code(s) that align with the opportunity. Only the code(s), never the description.
      Match Score: Calculate a match score using the following:
      For each relevant area among these skills, assign 25 points if the opportunity requires any of them, up to a maximum score of 100 points:
      Strategic Planning, Strategic Implementation, Factor Analysis, Integrated Marketing, Creative Studio, Event Management, Web Design and Development, Change Management, Talent Management, Digital Services, Program & Project Management, Business Process Engineering, AI and Data Science.
      Additionally, assign 100 points for NAICS code relevance if the code matches any of these: 5415, 541490, 541430, 541511, 541613, 519130, 519190, 541810.
      Deadline: Extract the deadline date for the proposal submission.
